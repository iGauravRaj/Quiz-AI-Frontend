    ...
    <div className={`host ${isQuestionActive ? "question-active" : ""}`}>
      <div className="code">
        <div className="wrap">
          ...
          {isLoading ? <div className="pincode">Loading...</div> : <div className="pincode">{room}</div>}
        </div>
      </div>
          ...
          <div className="question">
            ...
            <ul>
              {options.map((answer, index) => (
                <li key={index}>
                  <button disabled={answered} className={`options ${selectedAnswerIndex === index ? "selected" : ""}`}>
                    {answer}
                  </button>
                </li>
              ))}
