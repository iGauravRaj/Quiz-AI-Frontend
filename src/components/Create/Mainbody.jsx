...
function Mainbody() {
  ...
  const { mainQuestion, setHeadingQuestion, setMainQuestion, displayQuestion, setDisplayQuestion, quiz, setQuiz } =
    useContext(Question)
  ...
  const updateMainQuestion = (updatedFields) => {
    setMainQuestion((prevQuestions) =>
      prevQuestions.map((question) =>
        question.questionIndex === displayQuestion.questionIndex ? { ...question, ...updatedFields } : question,
      ),
    )
  }
    ...
    <div className="mainbody">
      <div className="main-bodyinput">
        ...
        <div className="image quiz-img ">
          <img className="xrc" src="quiz.png" alt="" />
          <p></p>
        </div>
      </div>
